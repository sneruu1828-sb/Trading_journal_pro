...
```json
{
  ...
  "version": "1.0.0",
  "description": "Sync server for trading journal application",
  "main": "server.js",
  "scripts": {
...
- **Idempotency support** to handle network retries safely
- **Authentication** via Bearer token (demo implementation)
- **Export/Import** functionality for data backup and migration
- **Statistics endpoint** for performance metrics
- **Error handling** with proper logging
- **CORS enabled** for cross-origin requests
- **Input validation** for UUIDs and required fields

## API Endpoints

### POST /api/sync
Synchronize trades and strategies between client and server.

### GET /api/changes?since=token&limit=100
...
### POST /api/import
Import trades and strategies from backup files.
